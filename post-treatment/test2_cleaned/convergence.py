...
f1 = open('test2_clean.txt_RHS_0.txt', 'r')
f2 = open('test2_clean.txt_RHS_1.txt', 'r')
f3 = open('test2_clean.txt_RHS_2.txt', 'r')
f4 = open('test2_clean.txt_RHS_3.txt', 'r')
...
for line2 in f3:
    val3.append(float(line2.split()[0]))
for line3 in f4:
    val4.append(float(line3.split()[0]))
...
p1.plot(val3, label='3rd Rhs',lw='1.',marker='', markevery=20,markersize='3',mew=1.3)
p1.plot(val4, label='4th Rhs', linestyle=':')
...
p1.set_xlabel('Iteration step number of classic Block GMRES with 4 Rhs', size='10')
p1.set_ylabel('Relative Residual', size='10')
formatter = ticker.ScalarFormatter()
formatter.set_scientific(True)
#formatter.set_powerlimits((0,0))
p1.yaxis.set_major_formatter(formatter)
p1.set_xticks(numpy.arange(0,150,60))
...
plt.savefig("test2_convergence.eps",dpi=500)
#plt.show()