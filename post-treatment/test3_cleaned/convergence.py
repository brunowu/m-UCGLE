...
f1 = open('test3_clean.txt_RHS_0.txt', 'r')
f2 = open('test3_clean.txt_RHS_1.txt', 'r')
...
p1.set_xlabel('Iteration step number of UCMGLE with 2 Rhs', size='10')
p1.set_ylabel('Relative Residual', size='10')
formatter = ticker.ScalarFormatter()
formatter.set_scientific(True)
#formatter.set_powerlimits((0,0))
p1.yaxis.set_major_formatter(formatter)
p1.set_xticks(numpy.arange(0,450,60))
...
plt.savefig("test3_convergence.eps",dpi=500)
#plt.show()